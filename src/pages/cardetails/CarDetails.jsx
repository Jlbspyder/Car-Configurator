...
const CarDetails = () => {
  ...
  const car = suvModels.find((model) => model.name === name);
...
// technology section button handlers
  ...
  const handleClick = () => {
    navigate(`/build/${car.name}/${spec.id}`);
  };
        ...
        <div
          className={
            car.name === "Telluride" || car.name === "Soul"
              ...
              : "bg-[#F2F2F2] mt-10 md:flex flex-row-reverse justify-between md:items-start pt-6 pb-40 text-black"
          }
        >
          <div className="md:w-[45%] xl:w-[50%]">
            <img src={car.largePix} alt={car.name} className="model-pix" />
          </div>
          <div className="md:w-[60%] xl:w-[52%] px-8 md:px-14 mt-6">
            <h5 className="font-semibold md:text-[12px] xl:text-[12px]">
              {car.teaser}
            </h5>
            <h1 className="text-[40px]/10 md:text-[35px] xl:text-[40px]/10 my-2 font-semibold">
              {car.header}
            </h1>
            <p className="mt-4 text-[18px] md:text-[16px] xl:text-[17px]">
              {car.desc}
            </p>
            <br />
            ...
            <h2 className="text-xl font-semibold md:text-[18px]/5 xl:text-xl">
              {car.standard && car.standard}
            </h2>
            <h1 className="text-[18px] md:text-[16px] xl:text-[18px] font-semibold">
        ...
        <div className="text-black relative pb-30 mt-10">
          ...
          {car.name === "Telluride" || car.name === "Soul" ? (
            <>
              ...
              <div onClick={moveIntUp} className="tech-arrow-right">
                <FaArrowLeft className="tech_arrow_up" />
              </div>
              <div onClick={moveIntDown} className="tech-arrow-left">
          ...
          <div className="text-black relative pb-30 mt-10">
            ...
            {car.name === "Telluride" || car.name === "Soul" ? (
              <>
                ...
                <div onClick={moveTechUp} className="__up">
                  <IoArrowUp className="_up" />
                </div>
                <div onClick={moveTechDown} className="__down">
                  <IoArrowDown className="_down" />
                </div>
              </>
            ) : (
